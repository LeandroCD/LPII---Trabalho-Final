	...
	<html lang="en">
		<head>
			...
			<!-- Template Personalizado-->
			 ...
			 <link href="<?php echo base_url ( 'bootstrap/css/clean-blog.min.css' );?>"	rel="stylesheet">
			...
			<!-- Script template-->
			<script src="<?php echo base_url('bootstrap/js/clean-blog.min.js');?>"></script>	
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="">Leandro Coelho</a>
            </div>
